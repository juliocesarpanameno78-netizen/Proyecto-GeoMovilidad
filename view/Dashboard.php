<!DOCTYPE html>
	...
	<head>
		...
		<!-- MapServer estilos para capas del mapa -->
		<style>
			#Layer1 {
				position: absolute;
				width: 162px;
	...
	<body>
						...
						<ul class="nav nav-secondary">
							...
							<li class="nav-item">
								...
								<div class="collapse" id="sidebarLayouts">
									<ul class="nav nav-collapse">
										<li><a href="sidebar-style-2.html"><span class="sub-item">Sidebar Style 2</span></a></li>
							...
							<li class="nav-item">
								...
								<div class="collapse" id="maps">
									<ul class="nav nav-collapse">
										...
										<li><a href="maps/jsvectormap.html"><span class="sub-item">Jsvectormap</span></a></li>
									</ul>
								</div>
							</li>
							<li class="nav-item">
			...
			<div class="main-panel">
				...
				<div class="container-fluid">
					<div class="page-inner">
						...
						<!-- CORRECCIÓN: Mapa integrado correctamente dentro de un card de Kaiadmin -->
						<div class="row mb-4">
							<div class="col-md-12">
									...
									<div class="card-body">
										<div style="position: relative; width: 100%; height: 500px;">
											...
											<div
												id="dc_main"
												class="mscross"
												style="overflow:hidden; width:550px; height:500px; position:relative; -moz-user-select:none;">
											</div>
											...
											<div id="Layer1">
												<div
													id="dc_main2"
													style="overflow:auto; width:140px; height:140px; position:relative; z-index:100;">
												</div>
											</div>
		...
		<!-- MapServer JS (al final, después de jQuery) -->
		...
		<script>
			...
			// MapServer
			var myMap1 = new msMap(document.getElementById("dc_main"), "standardRight");
			myMap1.setCgi("/cgi-bin/mapserv.exe");
			myMap1.setMapFile("/miprimermapa.map");
			...
			myMap2.setMapFile("/miprimermapa.map");

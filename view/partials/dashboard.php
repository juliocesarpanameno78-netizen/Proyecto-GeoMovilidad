            ...
            <div class="row mb-4">
                <div class="col-md-12">
                    <div class="card card-round">
                        ...
                        <div class="card-body">
                            <div style="position: relative; width: 100%; height: 800px; border: 1px solid #ddd; background: #f8f9fa;">
                                <div id="dc_main" class="mscross" style="overflow:hidden; width:1522em; height:800px; -moz-user-select:none;">
                                </div>
                                <div id="Layer2"
                                    ...
                                    <form name="select_layers">
                                        <p class="mb-2">
                                            <input checked onclick="chgLayers()" type="checkbox" name="Layer[0]" value="cali_area">

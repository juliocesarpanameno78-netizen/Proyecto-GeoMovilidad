...
class RegistroModel extends MasterModel {
    ...
    public function getTiposDocumento() {
        $sql = "SELECT tdoc_id AS id_tipos_documentos, tdoc_nombre AS nombre_tipos_doc FROM tipos_de_documento ORDER BY tdoc_id";
    ...
    public function registrar($datos) {
        ...
        $id_persona = $this->autoincrement('personas', 'per_id');
        ...
        $id_usuario = $this->autoincrement('usuarios', 'usu_id');

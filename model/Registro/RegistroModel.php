...
class RegistroModel extends MasterModel
{
    ...
    {
        $sql = "SELECT usu_id FROM usuarios WHERE usu_email = $1";
    ...
    {
        $sql = "SELECT usu_id FROM usuarios WHERE per_identificacion = $1";
    ...
    public function registrar($datos)
    {
        ...
        $sql_usuario = "INSERT INTO usuarios
                        (usu_id, bar_id, id_rol, usu_nombre, usu_contrasena, usu_email,
                         tdoc_id, per_identificacion, per_apellido, per_nombre, per_telefono, per_direccion)
